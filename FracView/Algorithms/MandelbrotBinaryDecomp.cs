...
namespace FracView.Algorithms
{
    ...
    /// </summary>
    public class MandelbrotBinaryDecomp : EscapeAlgorithm
    {
        private double _iterationBreakDouble;

        public MandelbrotBinaryDecomp(int progressCallbackIntervalSec = 0, Action<ProgressReport>? progressCallback = null)
        ...
        public MandelbrotBinaryDecomp(RunSettings settings, int progressCallbackIntervalSec = 0, Action<ProgressReport>? progressCallback = null)
