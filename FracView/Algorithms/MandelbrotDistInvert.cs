...
namespace FracView.Algorithms
{
    ...
    /// </summary>
    public class MandelbrotDistInvert : EscapeAlgorithm
    {
        private double _iterationBreakDouble;

        public MandelbrotDistInvert(int progressCallbackIntervalSec = 0, Action<ProgressReport>? progressCallback = null)
        ...
        public MandelbrotDistInvert(RunSettings settings, int progressCallbackIntervalSec = 0, Action<ProgressReport>? progressCallback = null)
