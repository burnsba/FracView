...
namespace FracView.Algorithms
{
    ...
    /// </summary>
    public class MandelbrotFish : EscapeAlgorithm
    {
        private double _iterationBreakDouble;

        public MandelbrotFish(int progressCallbackIntervalSec = 0, Action<ProgressReport>? progressCallback = null)
        ...
        public MandelbrotFish(RunSettings settings, int progressCallbackIntervalSec = 0, Action<ProgressReport>? progressCallback = null)
        ...
        public override bool IsStable(EvalComplexUnit eu)
        {
            ...
            for (eu.IterationCount = 1; eu.IterationCount < MaxIterations; eu.IterationCount++)
            {
                ...
                pa_x = xsquare - ysquare + eu_real - Math.Sin(pa_y);
                pa_y = xy + xy + eu_imag;
