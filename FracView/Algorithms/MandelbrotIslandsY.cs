...
namespace FracView.Algorithms
{
    ...
    /// </summary>
    public class MandelbrotIslandsY : EscapeAlgorithm
    {
        private double _iterationBreakDouble;

        public MandelbrotIslandsY(int progressCallbackIntervalSec = 0, Action<ProgressReport>? progressCallback = null)
        ...
        public MandelbrotIslandsY(RunSettings settings, int progressCallbackIntervalSec = 0, Action<ProgressReport>? progressCallback = null)
        ...
        public override bool IsStable(EvalComplexUnit eu)
        {
            ...
            for (eu.IterationCount = 1; eu.IterationCount < MaxIterations; eu.IterationCount++)
            {
                ...
                pa_x = xsquare - ysquare + eu_real + Math.Cos(pa_y);
                pa_y = xy + xy + eu_imag;
