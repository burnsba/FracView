...
namespace FracView.Algorithms
{
    ...
    /// </summary>
    public class MandelbrotStepStart2 : EscapeAlgorithm
    {
        private double _iterationBreakDouble;

        public MandelbrotStepStart2(int progressCallbackIntervalSec = 0, Action<ProgressReport>? progressCallback = null)
        ...
        public MandelbrotStepStart2(RunSettings settings, int progressCallbackIntervalSec = 0, Action<ProgressReport>? progressCallback = null)
