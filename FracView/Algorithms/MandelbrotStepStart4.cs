...
namespace FracView.Algorithms
{
    ...
    /// </summary>
    public class MandelbrotStepStart4 : EscapeAlgorithm
    {
        private double _iterationBreakDouble;

        public MandelbrotStepStart4(int progressCallbackIntervalSec = 0, Action<ProgressReport>? progressCallback = null)
        ...
        public MandelbrotStepStart4(RunSettings settings, int progressCallbackIntervalSec = 0, Action<ProgressReport>? progressCallback = null)
