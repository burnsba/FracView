...
namespace FracView.Algorithms
{
    ...
    /// </summary>
    public class MandelbrotStepNegate : EscapeAlgorithm
    {
        private double _iterationBreakDouble;

        public MandelbrotStepNegate(int progressCallbackIntervalSec = 0, Action<ProgressReport>? progressCallback = null)
        ...
        public MandelbrotStepNegate(RunSettings settings, int progressCallbackIntervalSec = 0, Action<ProgressReport>? progressCallback = null)
