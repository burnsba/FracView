...
namespace FracView.Algorithms
{
    ...
    /// </summary>
    public class MandelbrotStepStart16 : EscapeAlgorithm
    {
        private double _iterationBreakDouble;

        public MandelbrotStepStart16(int progressCallbackIntervalSec = 0, Action<ProgressReport>? progressCallback = null)
        ...
        public MandelbrotStepStart16(RunSettings settings, int progressCallbackIntervalSec = 0, Action<ProgressReport>? progressCallback = null)
