...
namespace FracView.Algorithms
{
    ...
    /// </summary>
    public class MandelbrotMriMinusLogX : EscapeAlgorithm
    {
        private double _iterationBreakDouble;

        public MandelbrotMriMinusLogX(int progressCallbackIntervalSec = 0, Action<ProgressReport>? progressCallback = null)
        ...
        public MandelbrotMriMinusLogX(RunSettings settings, int progressCallbackIntervalSec = 0, Action<ProgressReport>? progressCallback = null)
