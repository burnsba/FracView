...
namespace FracView.Algorithms
{
    ...
    /// </summary>
    public class MandelbrotStepInvert : EscapeAlgorithm
    {
        private double _iterationBreakDouble;

        public MandelbrotStepInvert(int progressCallbackIntervalSec = 0, Action<ProgressReport>? progressCallback = null)
        ...
        public MandelbrotStepInvert(RunSettings settings, int progressCallbackIntervalSec = 0, Action<ProgressReport>? progressCallback = null)
