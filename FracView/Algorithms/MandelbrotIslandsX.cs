...
namespace FracView.Algorithms
{
    ...
    /// </summary>
    public class MandelbrotIslandsX : EscapeAlgorithm
    {
        private double _iterationBreakDouble;

        public MandelbrotIslandsX(int progressCallbackIntervalSec = 0, Action<ProgressReport>? progressCallback = null)
        ...
        public MandelbrotIslandsX(RunSettings settings, int progressCallbackIntervalSec = 0, Action<ProgressReport>? progressCallback = null)
        ...
        public override bool IsStable(EvalComplexUnit eu)
        {
            ...
            for (eu.IterationCount = 1; eu.IterationCount < MaxIterations; eu.IterationCount++)
            {
                ...
                pa_x = xsquare - ysquare + eu_real + Math.Cos(pa_x);
                pa_y = xy + xy + eu_imag;
