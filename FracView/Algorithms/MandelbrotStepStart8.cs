...
namespace FracView.Algorithms
{
    ...
    /// </summary>
    public class MandelbrotStepStart8 : EscapeAlgorithm
    {
        private double _iterationBreakDouble;

        public MandelbrotStepStart8(int progressCallbackIntervalSec = 0, Action<ProgressReport>? progressCallback = null)
        ...
        public MandelbrotStepStart8(RunSettings settings, int progressCallbackIntervalSec = 0, Action<ProgressReport>? progressCallback = null)
